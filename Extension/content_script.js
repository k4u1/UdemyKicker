// ============================================================
// Stealth: Remove WebDriver/automation flags BEFORE any page
// code runs (including Cloudflare). This script runs at
// document_start in MAIN world, so it wins the race.
// ============================================================
try {
...
try {
    // Hide automation-related window properties
